...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group border-input shadow-2xs relative flex w-full items-center rounded-md border outline-hidden transition-[color,box-shadow,border]",
        "hover:border-primary h-9 has-[>textarea]:h-auto duration-200 ease-out bg-background ring-offset-background",
