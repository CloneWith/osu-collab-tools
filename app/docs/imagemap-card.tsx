    ...
    <Card id="imagemap">
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <p>
            {t.rich("intro.0", {
              bbcodeLink: (text) => (
                <a href="https://osu.ppy.sh/wiki/BBCode" className="doc-link">
                  {text}
                </a>
              ),
            })}
      ...
      <CardContent className="space-y-4">
        <Alert>
          ...
          <AlertDescription>{t("usage.preview.description")}</AlertDescription>
        </Alert>
        <div className="space-y-2">{t("usage.hosting.intro")}</div>
        <div className="space-y-2">{t("usage.hosting.feature")}</div>
        <div className="space-y-2">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <ul className="list-disc list-inside space-y-1 text-secondary-foreground">
            <li>
              <Kbd>Del</Kbd> - {t("shortcuts.selected.items.0")}
            </li>
            <li>
              <Kbd>Ctrl + D</Kbd> - {t("shortcuts.selected.items.1")}
            </li>
            <li>
              <KbdGroup>
                <Kbd>-</Kbd>
